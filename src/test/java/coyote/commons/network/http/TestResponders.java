...
public class TestResponders {
  ...
  public void checkIniParameter1() throws Exception {
    new Resource("browse", 100, null, null, "init").initParameter(String.class);
    new Resource("browse", 100, null, null, "init").initParameter(Integer.class);
  }


  @Test
  public void checkIniParameter2() throws Exception {
    assertEquals("init", new Resource("browse", 100, null, null, "init").initParameter(String.class));
    assertNull(new Resource("browse", 100, null, null).initParameter(String.class));
  }
  ...
  public void staticFiles() throws Exception {
    ...
    // The server sends a 408 but the client does not process it properly Need to redesign the test around the Apache client
...
//    response.close();
  ...
  public void uriToString() throws Exception {
    assertEquals("Resource{uri='/photos/:customer_id/:photo_id', Parts=[customer_id, photo_id]} Responder=GeneralResponder", new Resource("/photos/:customer_id/:photo_id", 100, GeneralResponder.class, null).toString());
  }
