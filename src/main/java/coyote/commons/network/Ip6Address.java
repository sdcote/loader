...
public class Ip6Address {
   ...
   */
  public static String addIPv6LeadZeros(final String address) {
    final StringTokenizer labels = new StringTokenizer(address, ":");
    String thisLabel;
    String retnValue = "";
    int tokenLength;
  ...
  public static String IPv6ptrQueryString(final String address) {
    if (isValidIPv6(address)) {
      final String fullAddress = addIPv6LeadZeros(address);
      final StringTokenizer labels = new StringTokenizer(fullAddress, ":");
      String thisLabel;
   ...
   */
  public static String stripIPv6LeadZeros(final String address) {
    final StringTokenizer labels = new StringTokenizer(address, ":");
    String thisLabel;
    String retnValue = "";
    int value;
