...
public class Login extends PermissionEnabledSubject {
   ...
   */
  public Login(final SecurityPrincipal principal, final CredentialSet creds) {
   ...
   */
  public boolean matchCredentials(final CredentialSet creds) {
    if (creds != null) {
   ...
   */
  public Role removeRole(final String name) {
    try {
   ...
   */
  public void setCredentials(final CredentialSet credentialset) {
   ...
   */
  public void setPrincipal(final SecurityPrincipal principal) {
    this.principal = principal;
  }
  ...
  */
  ...
  public String toString() {
    final StringBuilder b = new StringBuilder("Login: Principal=");
    if (principal != null) {
