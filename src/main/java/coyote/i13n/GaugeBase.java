 ...
 * or updated only once, maybe twice, per second.</p>
 */
public class GaugeBase extends NullGauge
{
   ...
   * array indexes for wraps in circular arrays.</p>
   */
  private class Node
  {
    long timestamp;
   ...
   * case of the activity was averaged out over the missing updates.</p>
   * 
   * <p>Last profiler metric: 0.001187 ms per call - 847,459cps</p>
   * 
