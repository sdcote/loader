...
public interface StatBoard {
     ...
     */
    Iterator<Counter> getCounterIterator();
     ...
     */
    Iterator<State> getStateIterator();
     ...
     * does not exist.
     */
    TimingMaster getTimerMaster(final String name);
     ...
     */
    Counter removeCounter(String name);
     ...
     */
    void setState(String name, double value);
     ...
     * @param value The value to set in the state.
     */
    void setState(String name, long value);
     ...
     */
    ArmTransaction startArm(String name);
     ...
     * @return A transaction to collect ARM data.
     */
    ArmTransaction startArm(String name, String crid);
     ...
     */
    void updateGauge(String name, long value);
     ...
     */
    long createEvent(final String appId, final String sysId, final String cmpId, final String msg, final int severity, final int majorCode, final int minorCode, final String category);
